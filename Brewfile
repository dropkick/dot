...
# Tool to compare and synchronize files and folders
cask "deltawalker"
...
cask "imazing"
# App to organize screenshots and photos
cask "inboard"
cask "inssider"
# Tool to scans a website checking for broken links
cask "integrity"
...
# App to make lists and help with organization
cask "taskpaper"
